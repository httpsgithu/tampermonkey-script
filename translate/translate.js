...
(() => {
    ...
    *{word-wrap:break-word!important}
    ...
    },
    {
        ...
        popup(text) {
            if (hasChineseByRange(text)) {
                popupCenter(`https://www.bing.com/translator?from=auto-detect&to=en&text=${encodeURIComponent(text)}`, null, 1024, 800);
            } else {
                popupCenter(`https://www.bing.com/translator?from=auto-detect&to=zh-Hans&text=${encodeURIComponent(text)}`, null, 1024, 800);
            }
        },
        custom(text) { }
    },
